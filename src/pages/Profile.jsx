...
import { User, Mail, Phone, Briefcase, Clock, Edit2, Save, X, Lock } from "lucide-react";
...
const Profile = () => {
  ...
  const handleChangePassword = async () => {
    try {
      await changePassword(token, passData.current, passData.new);
              ...
              <div className="space-y-6">
                <div className="grid gap-6">
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-300">
                    ...
                    <div className="flex-1">
                      <label className="block text-sm font-semibold text-gray-700 mb-2">Gender & Age</label>
                      {editing ? (
                        ...
                        <p className="text-gray-900 font-medium">
                          {profile.gender || "Gender not set"} • {profile.age || "Age not set"}
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  {!editing ? (
                    <>
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-6 py-3 border border-gray-200 text-gray-700 hover:bg-gray-50 rounded-xl font-semibold transition-all duration-300"
                      >
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setPassModalOpen(false)} className="p-2 hover:bg-gray-100 rounded-lg">
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-gray-200 text-gray-700 hover:bg-gray-50 rounded-lg font-semibold"
                >
                  Cancel
                </button>
                <button

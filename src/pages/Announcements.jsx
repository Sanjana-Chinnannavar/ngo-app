    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="mb-12">
          ...
          <p className="text-gray-600 mt-2">Stay updated with important news and events</p>
        </div>
            ...
            announcements.map((announcement, index) => (
              ...
              >
                  ...
                  {isAdmin(user) && (
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 border border-red-200 text-red-600 hover:bg-red-50 rounded-lg font-semibold transition-all duration-300 hover:border-red-300"
                      >
                ...
                <div className="bg-gradient-to-r from-gray-50 to-white px-6 sm:px-8 py-4 border-t border-gray-100 flex items-center justify-between group-hover:bg-gradient-to-r group-hover:from-teal-50 group-hover:to-gray-50 transition-all duration-300">
                  <span className="text-sm text-gray-600 font-medium">Announcement ID: {announcement.id}</span>
